...
def test(data,
    ...
    #     model_int8 = torch.quantization.convert(model_fp32_prepared)
        ...
        # Prune
    #from utils.torch_utils import custom_prune
    #custom_prune(model)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--weights', nargs='+', type=str, default='D:\zzw\slimming/new/runs/train\exp131_cocoepoch8\weights/best_cp.pt', help='model.pt path(s)')#yolov3.pt D:\zzw\slimming/new/runs/train\exp123_cocoepoch1\weights/best.pt'
    parser.add_argument('--data', type=str, default='data/coco.yaml', help='*.data path')#data/coco128.yaml
