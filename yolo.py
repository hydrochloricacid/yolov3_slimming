...
class Model(nn.Module):
    def __init__(self, cfg='models/yolov3.yaml', ch=3, nc=None, anchors=None):  # model, input channels, number of classes
    ...
    def forward_once(self, x, profile=False):
        ...
        for m in self.model:
            ...
            #to print feature map and bn fused weight and bias
